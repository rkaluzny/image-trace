...
Name: "addtopath"; Description: "Add ImageTrace CLI to the system PATH"; GroupDescription: "System Integration"; Components: cli;
...
Name: "{autoprograms}\{#MyAppName}\Website"; Filename: "{#MyAppURL}"
Name: "{autoprograms}\{#MyAppName}\License"; Filename: "{app}\license.txt"

[Registry]
; Adds the CLI directory to the system PATH if the user selected the task
Root: HKA; Subkey: "Environment"; ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};{app}\cli"; Tasks: addtopath
Root: HKCU; Subkey: "Environment"; ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};{app}\cli"; Tasks: addtopath
