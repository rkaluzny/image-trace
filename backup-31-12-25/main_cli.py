...
""")
    ...
    analysis_group.add_argument("--ela", action="store_true", help="Perform Error Level Analysis (ELA). Highlights differences in JPEG compression levels. Saves a result image.")
    ...
    analysis_group.add_argument("--string-analysis", action="store_true", help="Extract and display printable strings from the image's binary data.")
    analysis_group.add_argument("--thumbnail-analysis", action="store_true", help="Analyze the embedded thumbnail and compare it to the main image.")
    analysis_group.add_argument("--fingerprint", action="store_true", help="Attempt to identify the software used to save the image (Proof-of-Concept).")
